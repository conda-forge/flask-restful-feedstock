...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/flask-restful-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/flask-restful-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add flask-restful
# for installing globally
pixi global install flask-restful
```
...
It is possible to list all of the versions of `flask-restful` available on your platform:
...
```
pixi search flask-restful --channel conda-forge
```
